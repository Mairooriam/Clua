...
if "%1"=="" (
    ...
    echo Available: msvc-debug, msvc-release, mingw-debug, mingw-release, clang-debug, clang-release, clang-mingw-debug
    exit /b 1
)
...
if "%1"=="clang-mingw-debug" cmake --build build/clang-mingw-debug
